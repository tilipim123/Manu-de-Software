					...
					<ul class="dropdown-menu" aria-labelledby="entrar">
						<div class="col-md-12">
							...
							<form method="post" action="validar_acesso.php" id="formLogin">
								...
								<br /><br />
								<a href="https://www.facebook.com/dialog/oauth?client_id=544312629375425&redirect_uri=www.seusite.com.br/cadastro.php&scope=email,user_website,user_location">Entrar com Facebook</a>
